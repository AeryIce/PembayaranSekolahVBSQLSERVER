...
Public Class FormLoginPS 'pendeklarasian FormLoginPS sebagai class yang bersifat publik atau bisa diakses oleh siapa saja
	Private Sub ButtonCancel_Click(sender As Object, e As EventArgs) Handles ButtonCancel.Click
		Close()
	End Sub

	Private Sub FormLoginPS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
		Call Koneksi()
	End Sub
